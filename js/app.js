...
function resultsHTML() {
  ...
  if (state.searchError) {
    return `<div class="dp-results"><div class="dp-empty">
      ...
      <p>Nothing is shown rather than sample cars you might mistake for real listings.</p>
      <p class="dp-error-help">If this mentions a missing API key, the variable isn't reaching the
        running Worker. Open <a href="/api/health" target="_blank" rel="noopener">/api/health</a> —
        it reports exactly which variables the Worker can see, without exposing their values.</p>
